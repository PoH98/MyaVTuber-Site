  ...
  <section class="celebrate">
    <v-row class="bg-img">
      <v-col
        ...
        :key="i"
      >
        <img :ref="'bg_' + i" class="img-fluid bg-img-content" src="data:image/gif;base64," />
        <img :ref="'bg_clone_' + i" class="img-fluid bg-img-clone" src="data:image/gif;base64,"/>
      </v-col>
    </v-row>
